...
# NOTE (STA benchmark): keras/tensorflow imports stripped — the PyTorch DISCA
# (torch_disca_run.py) defines its own torch versions of the only functions in
# this file that touch keras (YOPO_classification, statistical_fitting,
# update_output_layer), so these are never called on the torch path.
# import keras
